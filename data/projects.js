...
window.HUT_PROJECTS = [
  {
    ...
    status: "under_regulering", statusLabel: "Under regulering",
  ...
  },
  {
    ...
    status: "ferdigstilt", statusLabel: "Sluttsolgt og ferdigstilt",
    completionYear: 2021, typeLabel: "Bolig og næring",
    units: { apartments: 75, apartmentsApprox: null },
    summary: "Ferdigstilt boligprosjekt på brygga i Holmestrand med 75 leiligheter og nye næringslokaler.",
  ...
  },
  {
    ...
    summary: "Tredje og siste byggetrinn i Bibliotekkvartalet, med 12 familieleiligheter og 14 kompakte leiligheter.",
  ...
  },
  {
    ...
    summary: "Andre byggetrinn i Bibliotekkvartalet, med 7 familieleiligheter og 16 kompakte leiligheter.",
  ...
  },
  {
    ...
    summary: "Første byggetrinn i Bibliotekkvartalet, med 10 unike utsiktsleiligheter og 9 kompakte leiligheter.",
  ...
  },
  {
    ...
    summary: "Ferdigstilt prosjekt med 39 leiligheter og nye næringsarealer på Dr. Graaruds Plass.",
